...
public class FetchLoanReportDetails extends AsyncTask<String, String, String> {
    private static String TAG = "FetchLoanReportDetails";
    public LoanReportInterface loanInterface = null;
    Context context;
    String message;
    ...
    public FetchLoanReportDetails(Context context,  String username, String password) {
    ...
    protected void onPostExecute(String s) {
        ...
        loanInterface.loanProcessFinish(s);
        Log.i(TAG, "onPostExecute: JSON: " + s);
    }

    public interface LoanReportInterface {
        void loanProcessFinish(String output);
    }
